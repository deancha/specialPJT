  ...
  $.initialize = function() {
    ...
    rangeSlider.slider({
      ...
      slide: function(event, ui) {
        minamount.val(ui.values[0].toLocaleString() + "원");
        maxamount.val(ui.values[1].toLocaleString() + "원");
      },
    });
    minamount.val(rangeSlider.slider("values", 0).toLocaleString() + "원");
    maxamount.val(rangeSlider.slider("values", 1).toLocaleString() + "원");
